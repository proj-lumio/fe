export const it = {
  ...
  companies: {
    ...
    piva: "P.IVA",
    piva_placeholder: "es. 01234567890",
    piva_hint: "Se inserita, i dati aziendali verranno arricchiti automaticamente dal registro imprese",
    enrich: "Arricchisci",
    enriching: "Arricchimento...",
    enrichment_started: "Arricchimento avviato in background",
    ...
    stato_attivita: "Stato Attivita",
    email_aziendale: "Email Aziendale",
    telefono: "Telefono",
    descrizione_ai: "Descrizione AI",
    enrichment_data: "Dati Arricchiti",
    registry_data: "Dati Registro",
    contacts: "Contatti",
  ...
  graph: {
    ...
    no_data: "Nessun dato disponibile. Carica documenti per costruire il knowledge graph.",
    nodes: "Nodi",
    edges: "Connessioni",
    company: "Azienda",
    document: "Documento",
